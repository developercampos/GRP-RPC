...
let User = (() => {
    ...
    let _datacadastro_decorators;
    let _datacadastro_initializers = [];
    let _datacadastro_extraInitializers = [];
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.datacadastro = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _datacadastro_initializers, void 0));
            this.ativo = (__runInitializers(this, _datacadastro_extraInitializers), __runInitializers(this, _ativo_initializers, void 0));
    ...
    (() => {
        ...
        _datacadastro_decorators = [(0, typeorm_1.CreateDateColumn)()];
        ...
        __esDecorate(null, null, _datacadastro_decorators, { kind: "field", name: "datacadastro", static: false, private: false, access: { has: obj => "datacadastro" in obj, get: obj => obj.datacadastro, set: (obj, value) => { obj.datacadastro = value; } }, metadata: _metadata }, _datacadastro_initializers, _datacadastro_extraInitializers);
